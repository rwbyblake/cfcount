...
class FileList(_FileList):
    ...
    def recursive_include(self, dir, pattern):
        """
        src all files anywhere in 'dir/' that match the pattern.
        """
    ...
    def global_include(self, pattern):
        """
        src all files anywhere in the current directory that match the
